...
// Brighter colors for visibility (upstream 9f9e0fb)
...
export class MilitaryPlugin implements WorldPlugin {
    ...
    renderEntity(entity: GeoEntity): CesiumEntityOptions {
        const altFeet = entity.properties?.altitude_ft as number | null | undefined;
        const isAirborne = !(entity.properties?.on_ground as boolean);
        return {
            type: "model",
            ...
            color: militaryAltitudeToColor(altFeet ?? null),
